...
import 'screens/financial_advice_screen.dart';
...
class _RootNavigationState extends State<RootNavigation> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> pages = [
      ...
      if (!isGuest) const ProfileScreen(),
    ...
    final items = [
      ...
      BottomNavigationBarItem(icon: const Icon(Icons.trending_up), label: 'Финансовый совет'),
      if (!isGuest)
