...
class UserPrefsService {
  ...
  Future<void> saveThemeToFirestore(String uid, String theme) async {
    // Disabled in no-Firebase mode
    // await _firestore.collection('users').doc(uid).set({'theme': theme}, SetOptions(merge: true));
  }

  Future<void> saveLanguageToFirestore(String uid, String language) async {
    // Disabled in no-Firebase mode
    // await _firestore.collection('users').doc(uid).set({'language': language}, SetOptions(merge: true));
  }
